  ...
  return (
    <>
      <div onClick={handleClick} className="hamburger">
        <span
          className={hidden === true ? "material-symbols-outlined" : "menu"}
        >
          menu
        </span>
        <span
          className={hidden === false ? "material-symbols-outlined" : "menu"}
        >
          close
        </span>
      </div>
      <div className="navContainer">
        ...
        <ul
          onClick={handleClick}
          className={hidden === true ? "navBar" : "navBar navShow"}
        >
          <li>
